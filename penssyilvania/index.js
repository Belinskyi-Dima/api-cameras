const requestOptions = {
  ...
  headers: {
    ...
    'referer': 'https://www.511pa.com/', // або правильний домен Alabama, можна й без нього
    'user-agent':
...
async function getPenssylvania(req,res) {
  // const originUrl ='https://pa-se4.arcadis-ivds.com:8200/chan-4306/'
  // const originUrl = 'https://pa-se2.arcadis-ivds.com:8200/chan-2944/';
    try {
    const idParam = req.params.id;
    const originUrl = req.query.originUrl
    console.log('[PA  master] id:', idParam);
    ...
    const url2 = `https://pa.arcadis-ivds.com/api/SecureTokenUri/GetSecureTokenUriBySourceId`;
    ...
    // фінальний m3u8:
    // const m3u8Url = `https://dis-se15.divas.cloud:8200/chan-1185_h/xflow.m3u8${secureTokenUri}`;
    const m3u8Url1 = `${originUrl}index.m3u8${secureTokenUri}`;

    const m3u8Url = `${originUrl}xflow.m3u8${secureTokenUri}`;
                // https://pa-se3.arcadis-ivds.com:8200/chan-4402/xflow.m3u8?token=dce0bfa032aa86fd2980e33d831bb31666a6f7bc702626fb09d35d3595386e32
